...
export default function CompleteInvitedProfilePage() {
   ...
   *
   * This refreshes the Firebase verification state and confirms the invitation
   * can still be linked to the signed-in account before personal details are saved.
   */
  useEffect(() => {
    let cancelled = false;
  ...
  const handleCompleteProfile =
    async (event) => {
      ...
      try {
        ...
        /*
         * The trusted completion operation returns the route derived from the
         * organization sector. Energy users therefore enter the energy dashboard
         * without passing through the normal organization onboarding.
         */
        navigate(
