  ...
  const handleCreateAccount =
    async (event) => {
      ...
      try {
        ...
        /*
         * Create the invited user's Firestore profile with the invitation
         * linkage needed to resume onboarding after email verification. Access
         * is assigned only after the verified user completes their profile.
         */
