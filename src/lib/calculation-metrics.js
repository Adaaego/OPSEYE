...
export const CALCULATION_SOURCE_METRICS = [
  ...
  /*
   * The current V1 deadline rule blocks submission after the deadline.
   * Therefore, most records will be either on_time or missed.
   *
   * The late classification remains available in case an administrator
   * later reopens a report or the policy changes.
   */
